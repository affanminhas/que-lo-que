...
import 'settingsbusinesspage_model.dart';
export 'settingsbusinesspage_model.dart';

class SettingsbusinesspageWidget extends StatefulWidget {
  const SettingsbusinesspageWidget({super.key});

  @override
  State<SettingsbusinesspageWidget> createState() =>
      _SettingsbusinesspageWidgetState();
}

class _SettingsbusinesspageWidgetState
    extends State<SettingsbusinesspageWidget> {
  late SettingsbusinesspageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsbusinesspageModel());
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      valueOrDefault<String>(
                                        settingsbusinesspageBusinessOwnerRecord
                                            .profileUrl,
