...
import 'usercreateadvertisepage_model.dart';
export 'usercreateadvertisepage_model.dart';

class UsercreateadvertisepageWidget extends StatefulWidget {
  const UsercreateadvertisepageWidget({super.key});

  @override
  State<UsercreateadvertisepageWidget> createState() =>
      _UsercreateadvertisepageWidgetState();
}

class _UsercreateadvertisepageWidgetState
    extends State<UsercreateadvertisepageWidget> {
  late UsercreateadvertisepageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UsercreateadvertisepageModel());
