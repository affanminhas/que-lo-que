...
import 'userchatpage_model.dart';
export 'userchatpage_model.dart';

class UserchatpageWidget extends StatefulWidget {
  const UserchatpageWidget({super.key});

  @override
  State<UserchatpageWidget> createState() => _UserchatpageWidgetState();
}

class _UserchatpageWidgetState extends State<UserchatpageWidget> {
  late UserchatpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserchatpageModel());
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(30.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1566138977236-8d8a94824b19?w=500&h=500',
                                          width: 60.0,
                                          height: 60.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(30.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1574835282112-00d4893f1e69?w=500&h=500',
                                          width: 60.0,
                                          height: 60.0,
                                          fit: BoxFit.cover,
                                        ),
