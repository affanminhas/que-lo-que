...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00FFFF);
  late Color secondary = const Color(0xFFDF5BCB);
  late Color tertiary = const Color(0xFFF01D8D);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00FFFF);
  late Color secondary = const Color(0xFFE34FCD);
  late Color tertiary = const Color(0xFFF01D8D);
