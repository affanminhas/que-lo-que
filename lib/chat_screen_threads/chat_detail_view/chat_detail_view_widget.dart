...
export 'chat_detail_view_model.dart';

class ChatDetailViewWidget extends StatefulWidget {
  const ChatDetailViewWidget({
    super.key,
  ...
  @override
  State<ChatDetailViewWidget> createState() => _ChatDetailViewWidgetState();
}

class _ChatDetailViewWidgetState extends State<ChatDetailViewWidget> {
  late ChatDetailViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatDetailViewModel());
