...
class SignupSelectionViewWidget extends StatefulWidget {
  const SignupSelectionViewWidget({
    super.key,
    bool? isFromGoogleLogin,
  }) : isFromGoogleLogin = isFromGoogleLogin ?? false;

  final bool isFromGoogleLogin;

  @override
  State<SignupSelectionViewWidget> createState() =>
      _SignupSelectionViewWidgetState();
}

class _SignupSelectionViewWidgetState extends State<SignupSelectionViewWidget> {
  late SignupSelectionViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignupSelectionViewModel());
