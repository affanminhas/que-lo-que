...
import 'businesschatpage_model.dart';
export 'businesschatpage_model.dart';

class BusinesschatpageWidget extends StatefulWidget {
  const BusinesschatpageWidget({super.key});

  @override
  State<BusinesschatpageWidget> createState() => _BusinesschatpageWidgetState();
}

class _BusinesschatpageWidgetState extends State<BusinesschatpageWidget> {
  late BusinesschatpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinesschatpageModel());
