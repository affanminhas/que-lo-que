...
import 'creatabusinessactivitypage_model.dart';
export 'creatabusinessactivitypage_model.dart';

class CreatabusinessactivitypageWidget extends StatefulWidget {
  const CreatabusinessactivitypageWidget({super.key});

  @override
  State<CreatabusinessactivitypageWidget> createState() =>
      _CreatabusinessactivitypageWidgetState();
}

class _CreatabusinessactivitypageWidgetState
    extends State<CreatabusinessactivitypageWidget> {
  late CreatabusinessactivitypageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatabusinessactivitypageModel());
